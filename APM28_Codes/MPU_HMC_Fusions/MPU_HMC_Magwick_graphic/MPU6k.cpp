...
void MPU6000::configureMPU6000() {
  SPIwrite(MPUREG_PWR_MGMT_1,BIT_H_RESET);            delay(100);// reset device
  SPIwrite(MPUREG_PWR_MGMT_1,MPU_CLK_SEL_PLLGYROZ);   delay(1); //wake device and select GyroZ clock 
