...
Vectorf HMC5883L::readRaw(void) {
    v.x = readRegister16(HMC5883L_REG_OUT_X_M) - xOffset;
    v.y = readRegister16(HMC5883L_REG_OUT_Y_M) - yOffset;
    v.z = readRegister16(HMC5883L_REG_OUT_Z_M);
    return v;
}
Vectorf HMC5883L::readNormalize(void) {
    v.x= ((float)readRegister16(HMC5883L_REG_OUT_X_M) - xOffset) * mgPerDigit;
    v.y = ((float)readRegister16(HMC5883L_REG_OUT_Y_M) - yOffset) * mgPerDigit;
